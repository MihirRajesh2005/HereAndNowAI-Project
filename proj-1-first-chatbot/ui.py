...
with gr.Blocks(theme="default", title=branding["organizationName"]) as demo:
    ...
    gr.ChatInterface(fn=get_response, chatbot=gr.Chatbot(height=500, avatar_images=(None,branding["chatbot"] ["avatar"]), type="messages"), title=branding["organizationName"], description=branding["slogan"], type="messages", examples=[["What is AI?"], ["Can you explain Neural Networks?"], ["How to build a chatbot?"], ["What is deep learning?"]])
